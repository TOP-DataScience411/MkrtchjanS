# Программа удаляет из введенного текста все знаки препинания и специальные символы, оставляя только буквы и пробелы.

text = input()
sign = '.,:;!?–—\'\"()*/'

clean = ''.join(char for char in text if char not in sign)
